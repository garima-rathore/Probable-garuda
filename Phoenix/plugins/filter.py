...
from . import *
from phoenix.sql.filter_sql import get_filter, add_filter, remove_filter, get_all_filters, remove_all_filters
...
@bot.on(phoenix_cmd(incoming=True))
...
@bot.on(phoenix_cmd(pattern=r"filter (.*)"))
...
@bot.on(phoenix_cmd(pattern="filters$"))
...
@bot.on(phoenix_cmd(pattern="stop (.*)"))
...
@bot.on(phoenix_cmd(pattern="rmallfilters$"))
