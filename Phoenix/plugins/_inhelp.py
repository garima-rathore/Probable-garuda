...
hell_pic = Config.PMPERMIT_PIC or "https://telegra.ph/file/af5a93637cf2e1d1e9849.png"
...
if Config.BOT_USERNAME is not None and tgbot is not None:
    ...
    async def inline_handler(event):
        ...
        if event.query.user_id == bot.uid and query == "hellbot_help":
            ...
            result = builder.article(
                title="Repository",
                text=f"**⚡ ʟɛɢɛռɖaʀʏ ᴀғ ☠ρøıƨøп ʙᴏᴛ☠  ⚡**",
                buttons=[
                    [Button.url("📑 Repo 📑", "https://t.me/shinchan_the_h4ch3r")],
                    [Button.url("🚀 Deploy 🚀", "https://dashboard.heroku.com/new?button-url=https%3A%2F%2Fgithub.com%2Fgarima-rathore%2FHellBot&template=https%3A%2F%2Fgithub.com%2Fgarima-rathore%2Fhellbot")],
                ],
            )
            ...
            result = builder.article(
                ...
                buttons=[
                    [
                        custom.Button.url("🔥 CHANNEL 🔥", "https://t.me/shinchan_the_hacker"),
                        custom.Button.url(
                            "⚡ GROUP ⚡", "https://t.me/shinchan_the_h4ch3r"
                        ),
                    ],
                    [
                        custom.Button.url(
    ...
    async def on_pm_click(event):
        if event.query.user_id == bot.uid:
            ...
            await event.edit(
                f"🔰 This is ☠ρøıƨøп ʙᴏᴛ☠ PM Security for {hell_mention} to keep away unwanted retards from spamming PM..."
            )
    ...
    async def page(event):
        ...
        if event.query.user_id == bot.uid or event.query.user_id in Config.SUDO_USERS:
            ...
            return await event.answer(
                "Hoo gya aapka. Kabse tapar tapar dabae jaa rhe h. Khudka bna lo na agr chaiye to. © ☠ρøıƨøп ʙᴏᴛ☠ ™",
                cache_time=0,
                alert=True,
            )
