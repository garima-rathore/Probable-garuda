...
@bot.on(phoenix_cmd(outgoing=True, pattern="carbon(?: |$)(.*)"))
...
async def carbon_api(e):
    ...
    phoenix = await edit_or_reply(e, "`Carbonizing...\n25%`")
    ...
    await phoenix.edit("`Done Dana Done...\n100%`")
    file = "./carbon.png"
    await phoenix.edit("`Uploading..`")
    await e.client.send_file(
        e.chat_id,
        file,
        caption="Here's your carbon, \n Carbonised by PHOENIX",
        force_document=True,
...
@bot.on(phoenix_cmd(outgoing=True, pattern="krb"))
@bot.on(sudo_cmd(pattern="krb", allow_sudo=True))
async def carbon_api(e):
    if e.fwd_from:
        return
    phoenix = await edit_or_reply(e, "`Processing....`")
    CARBON = "https://carbon.now.sh/?l={lang}&code={code}"
    textx = await e.get_reply_message()
    pcode = e.text
    if pcode[5:]:
    ...
    pcode = deEmojify(pcode)
    code = quote_plus(pcode)  # Converting to urlencoded
    await phoenix.edit("`Making Carbon...`\n`25%`")
    url = CARBON.format(code=code, lang=CARBONLANG)
    chrome_options = Options()
    chrome_options.add_argument("--headless")
...
@bot.on(phoenix_cmd(pattern=f"kar1(?: |$)(.*)", outgoing=True))
@bot.on(sudo_cmd(pattern="kar1(?: |$)(.*)", allow_sudo=True))
async def carbon_api(e):
    if e.fwd_from:
        return
    """ A Wrapper for carbon.now.sh """
    phoenix = await edit_or_reply(e, "🔲🔲🔲🔲🔲")
    ...
    await phoenix.edit("🔳🔳🔳🔳🔳")
    file = "./carbon.png"
    await phoenix.edit("☣️Karbon1 Completed, Uploading Karbon☣️")
    await e.client.send_file(
        e.chat_id,
        file,
        force_document=True,
    ...
    os.remove("./carbon.png")
    # Removing carbon.png after uploading
    await phoenix.delete()  # Deleting msg


@bot.on(phoenix_cmd(pattern=f"kar2(?: |$)(.*)", outgoing=True))
...
async def carbon_api(e):
    ...
    await phoenix.edit("🔘🔘🔘🔘🔘")
    file = "./carbon.png"
    await phoenix.edit("☣️Karbon2 Completed, Uploading Karbon☣️")
    await e.client.send_file(
        e.chat_id,
        file,
...
@bot.on(phoenix_cmd(pattern=f"kar3(?: |$)(.*)", outgoing=True))
...
async def carbon_api(e):
    ...
    await phoenix.edit("🔵🔵🔵🔵🔵")
    file = "./carbon.png"
    await phoenix.edit("☣️Karbon3 Completed, Uploading Karbon⬆️")
    await e.client.send_file(
        e.chat_id,
        file,
...
@bot.on(phoenix_cmd(pattern=f"kar4(?: |$)(.*)", outgoing=True))
...
async def carbon_api(e):
    ...
    await phoenix.edit("🌝🌝🌝🌝🌝")
    file = "./carbon.png"
    await phoenix.edit("✅Karbon4 Completed, Uploading Karbon✅")
    await e.client.send_file(
        e.chat_id,
        file,
...
@bot.on(phoenix_cmd(pattern=f"rgbk2(?: |$)(.*)", outgoing=True))
...
async def carbon_api(e):
    ...
    await phoenix.edit("⬛⬛⬛⬛⬛")
    file = "./carbon.png"
    await phoenix.edit("✅RGB Karbon 2.0 Completed, Uploading Karbon✅")
    await e.client.send_file(
        e.chat_id,
        file,
...
@bot.on(phoenix_cmd(pattern=f"kargb(?: |$)(.*)", outgoing=True))
...
async def carbon_api(e):
    ...
    await phoenix.edit("⬛⬛⬛⬛⬛")
    file = "./carbon.png"
    await phoenix.edit("✅RGB Karbon Completed, Uploading Karbon✅")
    await e.client.send_file(
        e.chat_id,
        file,
        caption=f"Here's your karbonrgb",
