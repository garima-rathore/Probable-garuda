...
@bot.on(phoenix_cmd(pattern=r"magisk"))
...
@bot.on(phoenix_cmd(outgoing=True, pattern=r"device(?: |$)(\S*)"))
...
@bot.on(phoenix_cmd(outgoing=True, pattern=r"codename(?: |)([\S]*)(?: |)([\s\S]*)"))
...
@bot.on(phoenix_cmd(outgoing=True, pattern=r"specs(?: |)([\S]*)(?: |)([\s\S]*)"))
...
@bot.on(phoenix_cmd(outgoing=True, pattern=r"twrp(?: |$)(\S*)"))
