...
@bot.on(phoenix_cmd(pattern="type (.*)"))
...
@bot.on(phoenix_cmd(pattern="emoji (.*)"))
...
@bot.on(phoenix_cmd(pattern=f"gendar$", outgoing=True))
...
@bot.on(phoenix_cmd(pattern=f"shrug$", outgoing=True))
...
@bot.on(phoenix_cmd(pattern=f"doge", outgoing=True))
...
@bot.on(phoenix_cmd(pattern=f"mesed$", outgoing=True))
...
@bot.on(phoenix_cmd(pattern=f"medead$", outgoing=True))
...
@bot.on(phoenix_cmd(pattern=f"confused$", outgoing=True))
...
@bot.on(phoenix_cmd(pattern=f"lobb$", outgoing=True))
...
@bot.on(phoenix_cmd(pattern=f"wut$", outgoing=True))
...
@bot.on(phoenix_cmd(pattern=f"wavee$", outgoing=True))
...
@bot.on(phoenix_cmd(pattern=f"hehe$", outgoing=True))
